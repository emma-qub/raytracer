...
void World::build(void) {
  int num_samples = 16;
    ...
    sphere_ptr1->set_material(matte_ptr1->clone());
    ...
    box_ptr1->set_material(matte_ptr2->clone());
    add_object(box_ptr1);
    ...
    triangle_ptr1->set_material(matte_ptr3->clone());
    ...
    plane_ptr->set_material(matte_ptr4->clone());
